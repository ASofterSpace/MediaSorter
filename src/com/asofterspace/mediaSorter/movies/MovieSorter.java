...
public class MovieSorter {
	...
	public void run() {
		...
		System.out.println("Starting movie sorting...");
				...
				if (filmContents.get(j).equals("Archive:")) {
					...
					for (int arcLineNum = j + 1; arcLineNum < filmContents.size(); arcLineNum++) {
						...
						if (arcLine.startsWith("Language:")) {
							curFilmLocation = new FilmLocation(curFilm, filmfileorigin, filmfileoriginalt, this);
	...
	private StringBuilder getHtmlTop(int filmAmount, boolean useFlatBackground) {
	...
	private void saveOverview(int filmAmount, List<String> genres, String filename, String overviewKind, String nullStr, String ovrStr, Map<String, String> genreToKeyMap) {
	...
	private void saveFilmsAsOverview(Map<String, List<Film>> films, String filename) {
	...
	private void appendFilmsToOverview(StringBuilder overview, List<Film> filmsInBracket) {
	...
	private void saveFilmFile(Film film, Map<String, String> genreToKeyMap, Map<String, Integer> langToNumberMap, String filmpath, String filename) {
	...
	private String mapFilmnameToSpecialFilmname(String filmname, Record filmMappings) {
	...
	private void addFilmsThatShouldBeFound(List<String> filesThatShouldBeFound, String origin) {
	...
	public void foundMediaFileIn(String location) {
